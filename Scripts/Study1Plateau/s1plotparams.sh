...
FitName=' from '.NumExp.'-exponential ${mmplotfile_corr}elated fit ({/Times:Italic Γ}_5, {/Times:Italic Γ}_4 {/Times:Italic Γ}_5 on 24^3 ensemble)'
...
do for [MyFieldNum = 0:NumExp - 1] {
  ...
  if (MyFieldNum==0) {
    ...
    set label "E_0=0.99656(95), ArXiv:1812.08791" at graph 0, first 0.99656 font "Arial,8" front textcolor "grey40" offset character 1, character 0.75
    #unset yrange
  } else {
    unset arrow
    unset label
...
set title '{/Times:Italic χ}^2 per d.o.f. '.FitName
#unset xrange
#set xrange [3.8:12.2]
#set xrange [5.8:12.2]
