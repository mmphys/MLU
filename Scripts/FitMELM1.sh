...
aKaonTIP=( 7  7  6  6  7)
aKaonTFP=(18 19 19 16 19)
aKaonTIW=(11  8  9  8 10)
aKaonTFW=(18 19 19 21 21)
...
unset FitOptions
for FileSeries in ${series-old disp dispind}
do
  ...
  do
    ...
    #NumExp=2 DeltaT="20 24 28 32" TI='11 11 11 11' TF='13 18 22 26' FitTwoStage 0
    ...
    NumExp=2 DeltaT="24 28 32" TI='8 8 16' TF='18 22 18' FitTwoStage 1 # Just to see Delta T=32
    NumExp=2 DeltaT="24 28" TI='10 10' TF='17 21' FitTwoStage 1
    NumExp=2 DeltaT="24 28 32" TI='10 10 16' TF='17 21 18' FitTwoStage 1 # Just to see Delta T=32

    NumExp=2 DeltaT="24 28" TI='10 10' TF='17 21' FitTwoStage 2
    NumExp=2 DeltaT="24 28 32" TI='10 10 15' TF='17 21 17' FitTwoStage 2 # Just to see Delta T=32

    NumExp=2 DeltaT="24 28" TI='10 10' TF='17 21' FitTwoStage 3
    NumExp=2 DeltaT="24 28 32" TI='10 10 20' TF='17 21 21' FitTwoStage 3 # Just to see Delta T=32

    NumExp=2 DeltaT="20 24" TI='10 10' TF='13 17' FitTwoStage 4
    NumExp=2 DeltaT="24 28" TI='10 10' TF='17 21' FitTwoStage 4
    NumExp=2 DeltaT="20 24 28 32" TI='10 10 14 20' TF='13 17 15 21' FitTwoStage 4 # See DT 28,32

    Gamma=gXYZ
    NumExp=2 DeltaT="20 24 28" TI='10 10 10' TF='13 17 21' FitTwoStage 1 # Preferred
    NumExp=2 DeltaT="20 24" TI='10 10' TF='13 17' FitTwoStage 1 # Preferred
    NumExp=2 DeltaT="24 28" TI='10 10' TF='17 21' FitTwoStage 1
    NumExp=2 DeltaT="24 28 32" TI='10 10 15' TF='17 21 23' FitTwoStage 1
    NumExp=2 DeltaT="24 28 32" TI='10 10 10' TF='17 21 25' FitTwoStage 1
    NumExp=2 DeltaT="24 28 32" TI='10 10 16' TF='17 21 18' FitTwoStage 1 # Just to see Delta T=32

    NumExp=2 DeltaT="20 24 28" TI='10 10 10' TF='13 17 21' FitTwoStage 2 # Preferred
    NumExp=2 DeltaT="20 24" TI='10 10' TF='13 17' FitTwoStage 2
    NumExp=2 DeltaT="24 28" TI='10 10' TF='17 21' FitTwoStage 2
    NumExp=2 DeltaT="24 28 32" TI='10 10 15' TF='17 21 23' FitTwoStage 2
    NumExp=2 DeltaT="24 28 32" TI='10 10 10' TF='17 21 25' FitTwoStage 2

    NumExp=2 DeltaT="20 24" TI='10 10' TF='13 17' FitTwoStage 3 # Preferred
    NumExp=2 DeltaT="20 24 28" TI='10 10 10' TF='13 17 21' FitTwoStage 3
    NumExp=2 DeltaT="24 28" TI='10 10' TF='17 21' FitTwoStage 3
    NumExp=2 DeltaT="24 28 32" TI='10 10 10' TF='17 21 25' FitTwoStage 3 # Just to see Delta T=32

    NumExp=2 DeltaT="20 24" TI='10 10' TF='13 17' FitTwoStage 4 # Preferred
    NumExp=2 DeltaT="20 24 28" TI='10 10 10' TF='13 17 21' FitTwoStage 4
    NumExp=2 DeltaT="24 28" TI='10 10' TF='17 21' FitTwoStage 4
    NumExp=2 DeltaT="24 28 32" TI='10 10 10' TF='17 21 25' FitTwoStage 4 # Just to see Delta T=32
...
if [ -v DoIdea ]; then # Give me an idea of what the ratios look like
  FileSeries=disp; ChooseTwoPtFits; FileSeries=idea; Gamma=gT
  NumExp=2 DeltaT="16 20 24 28 32" TI='9 11 11 11 11' TF='10 13 18 22 26' FitTwoStage 0
...
if [ -v Test ]; then # Do manual tests here
  (
